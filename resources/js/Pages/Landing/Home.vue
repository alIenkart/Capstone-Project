<template>
  <div class="mb-8">
    <section
      class="relative w-full min-h-[350px] flex flex-col justify-center text-white px-12 py-12"
      :style="{
    ...
    <section class="max-w-6xl mx-auto px-4 text-center mt-12">
      <h2
        class="text-xl font-bold text-[#1E71B8] border-b-4 border-[#1E71B8] inline-block pb-1 mb-3 mt-8"
      >
        WELCOME TO JE TRAVEL & TOURS!
      </h2>
      <p class="text-base text-black mb-8">
        Planning a trips? JE Travel & Tours is here to provide you a wide range
        of tour and guidance towards a meaningful and memorable travel. The
        agency is specialized in creating seamless travel experiences and is
        <span v-if="showMore">
          dedicated to providing clear and reliable service to make your journey
          enjoyable and stress free. Let the team help you to plan your next
          journey! Book now!
        </span>
      </p>
      <button
    ...
    <section class="max-w-6xl mx-auto px-4 mt-16 text-center">
      <h2
        class="text-2xl font-semibold text-[#1E71B8] relative inline-block mb-12"
      >
        Exclusive Destination
        <span
          class="absolute left-0 bottom-[-8px] w-full h-[3px] bg-[#1E71B8] rounded-full"
        ></span>
      </h2>
      <div class="flex flex-wrap justify-center gap-10">
        ...
        >
          ...
          <h3 class="text-xl font-bold text-[#1E71B8] mb-3">
            {{ pkg.package_name }}
          </h3>
