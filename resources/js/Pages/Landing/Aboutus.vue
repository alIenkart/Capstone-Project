<template>
  <section class="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
    <div
      v-if="aboutUs"
      class="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start"
    >
      <div
        class="rounded-xl overflow-hidden shadow ring-1 ring-gray-200/60 bg-gray-50"
      >
        <img
      ...
      <div class="space-y-8">
        <div>
          <h2
            class="text-2xl font-semibold tracking-wide text-[#1E71B8] uppercase"
          >
            {{ aboutUs.title }}
          </h2>
        ...
        <div class="space-y-4">
          <h3 class="text-lg font-bold text-[#000000] uppercase">
            Why Must Choose Us
          </h3>
