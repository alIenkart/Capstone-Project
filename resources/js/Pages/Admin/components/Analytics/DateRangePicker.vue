    ...
    <div class="relative" ref="calendarContainer">
        <div class="grid grid-cols-2 gap-4 mb-6">
            ...
            <div>
                ...
                <button type="button" @click="openCalendar('end')" :disabled="!startDate"
        ...
        <Teleport to="body" v-if="showCalendar">
            ...
            <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-2xl shadow-2xl border border-slate-200 p-8 w-full max-w-md"
                ref="calendarPopup">
                ...
                <div class="border-t border-slate-200 pt-6">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="button" @click="confirmSelection" :disabled="!startDate || !endDate"
...
const isStartDate = (day) => {
    ...
    const dateStr = dateToString(new Date(currentMonth.value.getFullYear(), currentMonth.value.getMonth(), day))
...
const selectDate = (day) => {
    ...
    const selected = new Date(currentMonth.value.getFullYear(), currentMonth.value.getMonth(), day)
...
const handleClickOutside = (e) => {
    if (calendarContainer.value && !calendarContainer.value.contains(e.target) &&
        calendarPopup.value && !calendarPopup.value.contains(e.target)) {
        closeCalendar()
    }
}

watch(() => props.modelValueStart, (newValue) => {
    startDate.value = newValue
})

watch(() => props.modelValueEnd, (newValue) => {
