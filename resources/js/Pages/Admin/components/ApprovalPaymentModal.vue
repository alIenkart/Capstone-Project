<template>
  ...
  >
    <div
      class="relative bg-white rounded-3xl shadow-2xl w-full max-w-4xl overflow-hidden"
    >
      <!-- Header -->
      <div
        class="bg-gradient-to-r from-[#217093] to-[#2a8bb5] px-8 py-6 relative"
      >
      ...
      <div class="px-8 py-6 max-h-[calc(100vh-16rem)] overflow-y-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="space-y-6">
            ...
            <div
              class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200"
            >
              <div class="flex items-center gap-2 mb-4">
                <svg
                  class="w-5 h-5 text-[#217093]"
            ...
            <div
              class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200"
            >
              ...
              >
                <div class="space-y-2">
                  <div class="flex justify-between text-sm">
                    ...
                    <span class="font-semibold text-gray-800"
                      >₱ {{ currentPayment?.fullPaymentAmount }}</span
                    >
                  </div>
                  <div
                    class="flex justify-between text-lg font-bold pt-2 border-t border-emerald-200"
                  >
          ...
          <div class="space-y-6">
            <div
              class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200"
            >
              <div class="flex items-center gap-2 mb-4">
                <svg
                  class="w-5 h-5 text-[#217093]"
      ...
      <div v-if="!isPaymentComplete() && !isPaymentRejected()">
        <div class="bg-gray-50 px-8 py-6 border-t border-gray-200">
          <div class="flex flex-wrap justify-center gap-4">
            <div v-if="!isDownPayment()">
              <button
                @click="submitVerificationOfPayment('Approved')"
            ...
            <div v-else>
              <button
                @click="submitVerificationOfPayment('Down Payment Approved')"
                class="flex items-center gap-2 rounded-xl bg-gradient-to-r from-green-600 to-green-700 px-8 py-3 text-white font-semibold hover:from-green-700 hover:to-green-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                <svg
                  class="w-5 h-5"
      ...
      >
        ...
        >
          ...
          <form @submit.prevent="confirmReject" class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1"
                >Rejection Category <span class="text-red-500">*</span></label
              >
              <input
                v-model="rejectionCategory"
                type="text"
                placeholder="Enter category"
                class="w-full rounded-xl border-2 border-gray-300 focus:border-red-500 focus:ring-1 focus:ring-red-500 px-4 py-2 outline-none"
                required
              />
            </div>
          ...
          <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-bold text-red-600"
                >₱ {{ receiptData.remainingBalance }}</span
              >
            </div>
          </div>
        </div>
