      ...
      >
        ...
        <div class="bg-gradient-to-r from-[#217093] to-[#2a8bb5] px-8 py-8">
          ...
          <p class="mt-2 text-white/80 text-sm">
            Create a new travel package with detailed information
          </p>
        </div>
                  ...
                  >
                    <template v-if="imagePreview">
                      <div class="relative w-full">
                        ...
                        >
                          <span
                            class="text-white font-semibold text-sm bg-[#217093] px-4 py-2 rounded-full shadow-lg"
                    ...
                    <template v-else>
                      ...
                      <span
                        class="text-base font-bold text-slate-700 group-hover:text-[#217093] mb-1"
            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div class="relative" ref="statusDropdown">
                    ...
                    >
                      <div
                        @click="handleStatusSelect('Active')"
                        :class="[
                          'px-4 py-3 cursor-pointer transition-all duration-150 flex items-center gap-3 border-b border-gray-100 hover:bg-blue-50',
                      ...
                      <div
                        @click="handleStatusSelect('Inactive')"
                        :class="[
              ...
              >
                ...
                <textarea
                  ...
                  placeholder="Describe the package in detail. What makes it special? What experiences await?"
                  required
                ></textarea>
              </div>
              ...
              >
                <div class="flex items-center justify-between mb-5">
                  ...
                  >
                    {{ itineraryDays.length }} / {{ maxItineraryDays }}
                  ...
                  <TransitionGroup name="list">
                    ...
                    >
                      ...
                      <textarea
                        ...
                        rows="4"
                        class="w-full rounded-xl border-2 border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 px-4 py-3 text-sm outline-none transition-all resize-none"
                      ></textarea>
                    </div>
                  </TransitionGroup>
                  ...
                  <div v-if="isAddDayButtonDisabled" class="group relative">
                    ...
                    >
                      <span v-if="!formData.startDate || !formData.endDate"
                        >Please select start and end dates first</span
                      >
                      <span v-else
                        >Maximum {{ maxItineraryDays }} days reached</span
                      >
                    </div>
                  </div>
              ...
              >
                ...
                <textarea
                  ...
                  rows="5"
                  class="w-full rounded-xl border-2 border-slate-200 focus:border-[#217093] focus:ring-4 focus:ring-[#217093]/10 px-4 py-3 text-sm outline-none transition-all resize-none"
                  placeholder="List what's not included in the package (e.g., airfare, meals, activities)..."
                ></textarea>
              </div>
            </div>
          </div>
