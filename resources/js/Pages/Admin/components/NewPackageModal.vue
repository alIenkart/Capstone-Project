            ...
            <div
                ...
                <div class="bg-gradient-to-r from-[#217093] to-[#2a8bb5] px-8 py-8">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-white/80 text-sm">Create a new travel package with detailed information
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="basePrice" v-model="formData.basePrice"
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <span
                                                class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-lg">₱</span>
                                            <input type="number" id="kidsBasePrice" v-model="formData.kidsBasePrice"
                            ...
                            <div
                                ...
                                <textarea id="termsCondition" v-model="formData.termsCondition" rows="5"
                                    class="w-full rounded-xl border-2 border-slate-200 focus:border-[#217093] focus:ring-4 focus:ring-[#217093]/10 px-4 py-3 text-sm outline-none transition-all resize-none"
                                    placeholder="Enter terms and conditions that apply to this package..."></textarea>
                            </div>
                            ...
                            <div
                                ...
                                <textarea id="exclusions" v-model="formData.exclusions" rows="5"
                                    class="w-full rounded-xl border-2 border-slate-200 focus:border-[#217093] focus:ring-4 focus:ring-[#217093]/10 px-4 py-3 text-sm outline-none transition-all resize-none"
                                    placeholder="List what's not included in the package (e.g., airfare, meals, activities)..."></textarea>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="bg-gradient-to-r from-slate-50 to-white px-8 py-6 border-t-2 border-slate-200">
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" @click="savePackage"
