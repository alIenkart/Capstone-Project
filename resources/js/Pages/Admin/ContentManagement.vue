<template>
  <div class="space-y-8 max-w-[1800px] mx-auto">
    ...
    <section class="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div class="space-y-4">
        <div
          v-for="item in filteredIntroduction"
          :key="item.id"
      ...
      >
        ...
        <div class="flex items-center gap-4 mt-4 sm:mt-0">
          ...
          >
            <img
              v-if="ourStory.image"
              :src="getImageUrl(ourStory.image)"
              alt="Our Story"
              class="w-full h-full object-cover"
            />
            <span v-else class="text-gray-500 text-sm text-center"
    ...
    <section class="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        ...
        >
          <img
            :src="getImageUrl(accred.image)"
            alt="Accreditation"
            class="w-full h-full object-cover"
          />
          <button
            @click="deleteAccreditation(accred.id)"
        ...
        <div
          v-if="accreditations.length === 0"
          class="col-span-2 sm:col-span-3 md:col-span-4 text-center py-12"
        >
          <svg
      ...
      <div class="space-y-4">
        ...
        <div v-if="filteredBlogs.length === 0" class="text-center py-12">
          ...
          <p class="text-gray-400 text-sm mt-1">
            Add your first travel blog to get started
          </p>
        </div>
      </div>
    </section>
    ...
    >
      <div
        class="bg-white rounded-3xl shadow-2xl w-full max-w-2xl relative overflow-hidden animate-slideUp"
      >
        <div
          class="bg-gradient-to-r from-[#1E71B8] to-[#2a8bb5] px-8 py-6 relative overflow-hidden"
        >
          ...
          <div class="relative flex items-center justify-between">
            <div>
              ...
              <p class="text-white/80 text-sm">
                Update your content details and imagery
              </p>
            </div>
            <button
              @click="closeModal"
        ...
        <div
          class="px-8 py-6 max-h-[calc(100vh-200px)] overflow-y-auto custom-scrollbar"
        >
          <div class="space-y-6">
            <div class="space-y-3">
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                ...
                <textarea
                  ...
                  rows="4"
                  class="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 focus:border-[#1E71B8] focus:ring-4 focus:ring-[#1E71B8]/10 outline-none transition-all resize-none text-gray-800"
                ></textarea>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div class="relative flex items-center justify-between">
            <div>
              ...
              <p class="text-white/80 text-sm">
                Update mission, vision, and why choose us
              </p>
            </div>
            <button
          ...
          <div class="space-y-6">
            <div class="space-y-3">
              ...
              <div
                ...
                @click="pickAboutUsImage"
              >
                <div
                  class="relative w-full h-56 rounded-2xl border-2 border-dashed border-gray-300 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 transition-all duration-300 group-hover:border-[#1E71B8] group-hover:shadow-lg"
                >
                  <img
                    v-if="previewAboutUsImage"
                    :src="previewAboutUsImage"
                    alt="Preview"
                    class="w-full h-full object-cover"
                  />
                  <div
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                ...
                >
                <input
                  v-model="editableAboutUs.subtitle"
                  type="text"
                  class="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 focus:border-[#1E71B8] focus:ring-4 focus:ring-[#1E71B8]/10 outline-none transition-all text-gray-800"
                />
              </div>
              ...
              <div class="space-y-2">
                ...
                >
                <textarea
                  v-model="editableAboutUs.mission"
                  rows="4"
                  class="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 focus:border-[#1E71B8] focus:ring-4 focus:ring-[#1E71B8]/10 outline-none transition-all resize-none text-gray-800"
                ></textarea>
              </div>
              ...
              <div class="space-y-2">
                ...
                >
                <textarea
                  v-model="editableAboutUs.vision"
                  rows="4"
                  class="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 focus:border-[#1E71B8] focus:ring-4 focus:ring-[#1E71B8]/10 outline-none transition-all resize-none text-gray-800"
                ></textarea>
              </div>
              ...
              <div class="space-y-2">
                ...
                >
                <textarea
                  v-model="editableAboutUs.why_choose_us"
                  rows="4"
                  class="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 focus:border-[#1E71B8] focus:ring-4 focus:ring-[#1E71B8]/10 outline-none transition-all resize-none text-gray-800"
                ></textarea>
              </div>
        ...
        >
          <div class="space-y-6">
            <div class="space-y-3">
              ...
              <div
                class="relative group cursor-pointer"
                @click="pickOurStoryImage"
              >
                <div
                  class="relative w-full h-56 rounded-2xl border-2 border-dashed border-gray-300 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 transition-all duration-300 group-hover:border-[#1E71B8] group-hover:shadow-lg"
                >
                  <img
                    v-if="previewOurStoryImage"
                    :src="previewOurStoryImage"
                    alt="Preview"
                    class="w-full h-full object-cover"
                  />
                  <div
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                ...
                >
                <input
                  v-model="editableOurStory.subtitle"
                  type="text"
                  class="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 focus:border-[#1E71B8] focus:ring-4 focus:ring-[#1E71B8]/10 outline-none transition-all text-gray-800"
                />
              </div>
              ...
              <div class="space-y-2">
                ...
                >
                <textarea
                  v-model="editableOurStory.description"
                  rows="6"
                  class="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 focus:border-[#1E71B8] focus:ring-4 focus:ring-[#1E71B8]/10 outline-none transition-all resize-none text-gray-800"
                ></textarea>
              </div>
        ...
        <div class="px-8 py-6">
          <div class="space-y-6">
            <div class="space-y-3">
              ...
              <div
                class="relative group cursor-pointer"
                @click="pickAccreditationImage"
              >
                <div
                  class="relative w-full h-56 rounded-2xl border-2 border-dashed border-gray-300 overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 transition-all duration-300 group-hover:border-[#1E71B8] group-hover:shadow-lg"
                >
                  <img
                    v-if="previewAccreditationImage"
                    :src="previewAccreditationImage"
                    alt="Preview"
                    class="w-full h-full object-cover"
                  />
                  <div
      ...
      >
        ...
        >
          ...
          <div class="relative flex items-center justify-between">
            <div>
              <h2 class="text-2xl font-bold text-white mb-1">
                {{ isEditingBlog ? "Edit" : "Add" }} Travel Blog
              </h2>
              <p class="text-white/80 text-sm">
                {{
                  isEditingBlog
                    ? "Update your travel blog details"
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                ...
                >
                <input
                  v-model="editableBlog.destination"
                  type="text"
...
const saveEdit = async () => {
  try {
    ...
    const response = await service.updateContent(
    ...
    if (file) {
      finalResponse = await service.uploadContentImage(
        editableItem.value.id,
        file
      );
    ...
    const index = contents.value.findIndex(
      (i) => i.id === editableItem.value.id
    );
    if (index !== -1) {
      contents.value[index] = finalResponse.data;
    }

    previewImage.value = finalResponse.data.image
      ? getImageUrl(finalResponse.data.image)
      : null;
...
const openEditAboutUs = () => {
  if (aboutUs.value) {
    ...
    previewAboutUsImage.value = aboutUs.value.image
      ? getImageUrl(aboutUs.value.image)
      : null;
...
const pickAboutUsImage = () => {
  aboutUsFileInput.value?.click();
};
...
const saveAboutUs = async () => {
  try {
    ...
    previewAboutUsImage.value = finalResponse.data.image
      ? getImageUrl(finalResponse.data.image)
      : null;
...
const openEditOurStory = () => {
  if (ourStory.value) {
    ...
    previewOurStoryImage.value = ourStory.value.image
      ? getImageUrl(ourStory.value.image)
      : null;
...
const pickOurStoryImage = () => {
  ourStoryFileInput.value?.click();
};
...
const saveOurStory = async () => {
  try {
    ...
    previewOurStoryImage.value = finalResponse.data.image
      ? getImageUrl(finalResponse.data.image)
      : null;
...
const pickAccreditationImage = () => {
  accreditationFileInput.value?.click();
};
...
const saveBlog = async () => {
  ...
  try {
    ...
    if (isEditingBlog.value) {
      ...
      const response = await service.updateTravelBlog(
        editableBlog.value.id,
        payload
      );

      let finalResponse = response;
      if (file) {
        finalResponse = await service.uploadTravelBlogImage(
          editableBlog.value.id,
          file
        );
        toast.success("Image uploaded successfully!");
      ...
      const index = blogs.value.findIndex(
        (b) => b.id === editableBlog.value.id
      );
      if (index !== -1) {
        blogs.value[index] = {
          ...finalResponse.data,
          image: finalResponse.data.image
            ? getImageUrl(finalResponse.data.image)
            : "",
        };
      }
